...
public class GUI_Menu : MonoBehaviour {
				...
				if(Input.GetMouseButtonDown(0)){
					if(hotKeySlot[0].hotKeyslot[CheckHoverSlotHotkey()].isItem == true){
						...
						if(hotKeySlot[0].hotKeyslot[CheckHoverSlotHotkey()].typeSkill == TypeSkillHover.Buff){
							itemImg_Pickup = playerSkill.activeSkillSupport[playerSkill.FindSkillIndex(hotKeySlot[0].hotKeyslot[CheckHoverSlotHotkey()].item_id)].skillIcon;
							item_pickup.item_id = playerSkill.activeSkillSupport[playerSkill.FindSkillIndex(hotKeySlot[0].hotKeyslot[CheckHoverSlotHotkey()].item_id)].skillID;
			...
			if(CheckSlotSkill() != -1 && skillWindow[0].openSkillWindow){
				if(Input.GetMouseButtonDown(0)){
					...
					if(typeSkillHover == TypeSkillHover.Buff){
						if(playerStatus.status.lv >= playerSkill.activeSkillSupport[CheckSlotSkill()-playerSkill.passiveSkill.Count].unlockLevel){
							itemImg_Pickup = playerSkill.activeSkillSupport[CheckSlotSkill()-playerSkill.passiveSkill.Count].skillIcon;
							item_pickup.item_id = playerSkill.activeSkillSupport[CheckSlotSkill()-playerSkill.passiveSkill.Count].skillID;
							item_pickup.typeSkill = TypeSkillHover.Buff;
						}
					}else if(typeSkillHover == TypeSkillHover.Attack){
						if(playerStatus.status.lv >= playerSkill.activeSkillAttack[CheckSlotSkill()-playerSkill.passiveSkill.Count-playerSkill.activeSkillSupport.Count].unlockLevel){
							itemImg_Pickup = playerSkill.activeSkillAttack[CheckSlotSkill()-playerSkill.passiveSkill.Count-playerSkill.activeSkillSupport.Count].skillIcon;	
							item_pickup.item_id = playerSkill.activeSkillAttack[CheckSlotSkill()-playerSkill.passiveSkill.Count-playerSkill.activeSkillSupport.Count].skillID;
							item_pickup.typeSkill = TypeSkillHover.Attack;
						}
					}
					pickupStay = true;
			...
			if(hotKeySlot[0].hotKeyslot[i].item_id == 0){
				...
				if(hotKeySlot[0].hotKeyslot[i].isItem == true){
					...
					if(hotKeySlot[0].hotKeyslot[i].typeSkill == TypeSkillHover.Passive){
						...
						GUI.DrawTexture(GUI_Calculate.RectWithScrren_WidthAndHeight_SizeWidth(new Vector2(hotKeySlot[0].hot_key_Rect.x + ((hotKeySlot[0].hot_key_Rect.width + hotKeySlot[0].space_Slot) * i), hotKeySlot[0].hot_key_Rect.y), new Vector2(hotKeySlot[0].hot_key_Rect.width, hotKeySlot[0].hot_key_Rect.height)), playerSkill.activeSkillSupport[playerSkill.FindSkillIndex(hotKeySlot[0].hotKeyslot[i].item_id)].skillIcon);	
	...
	private void ShowWindowDropAmount(){
		if(showDropAmount){
			...
			//{
				...
				if(amountDrop > 0 && isBuyItem == false && !itemShop[0].openItemShop){
				...
				}else if(money < (Item_Data.instance.Get_Item(item_pickup.item_id).price * amountDrop) && isBuyItem){
					
					//Show can Not Buy
					LogText.Instance.SetLog(GameSetting.Instance.logTimer,GameSetting.Instance.logSettingCantBuy);
					
				}else if(amountDrop > 0 && isBuyItem == false && itemShop[0].openItemShop){ //isItemFormInventory == true
	...
	{
		if(!CheckHoverInventory() && !CheckHoverEquipment())
		{
			if(Pickup_Item(item.GetComponent<Item_Obj>())){
			Destroy(item);
			}
		}
	...
	public void CallShop(GameObject Npc)
	{
		if(!CheckHoverInventory() && !CheckHoverEquipment() && !CheckHoverSkillWindow() && CheckHoverSlotHotkey() == -1 && itemShop[0].openItemShop == false){
			playerController.dontClick = true;
			OpenItemShopWindow();
			itemShop[0].itemID = Npc.GetComponent<ShopItemlist>().itemID;
		}
	}
	
	public void CallSaveWindow(GameObject Npc)
	{
		if(!CheckHoverInventory() && !CheckHoverEquipment() && !CheckHoverSkillWindow() && CheckHoverSlotHotkey() == -1 && itemShop[0].openItemShop == false){
			playerController.dontClick = true;
			SaveWindow.enableWindow = true;
	...
	private void FunctionSkillWindow(int windowID){
		...
		skillWindow[0].scrollViewRect.height = ((((playerSkill.activeSkillAttack.Count-1)+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].slotSkillRect.height) * skillWindow[0].space) + skillWindow[0].offset.y + (skillWindow[0].slotSkillRect.height/2 + skillWindow[0].offset.y/2);
		...
		for(int i = 0; i < playerSkill.activeSkillSupport.Count; i++){
			if(useStyle){
				...
				GUI.Box(new Rect(skillWindow[0].skillNameRect.x + skillWindow[0].offset.x, skillWindow[0].skillNameRect.y + (((i+playerSkill.passiveSkill.Count) * skillWindow[0].skillNameRect.height) * skillWindow[0].spaceSkillName) + skillWindow[0].offset.y, skillWindow[0].skillNameRect.width, skillWindow[0].skillNameRect.height), new GUIContent(playerSkill.activeSkillSupport[i].skillName ,"skillWindow"+(i).ToString()), guiStyleGroup[0].skillNameStyle);
				GUI.Box(new Rect(skillWindow[0].skillTypeRect.x + skillWindow[0].offset.x, skillWindow[0].skillTypeRect.y + (((i+playerSkill.passiveSkill.Count) * skillWindow[0].skillTypeRect.height) * skillWindow[0].spaceSkillType) + skillWindow[0].offset.y, skillWindow[0].skillTypeRect.width, skillWindow[0].skillTypeRect.height), new GUIContent(playerSkill.activeSkillSupport[i].typeSkill ,"skillWindow"+(i).ToString()), guiStyleGroup[0].skillTypeStyle);
				GUI.Box(new Rect(skillWindow[0].skillManaUseRect.x + skillWindow[0].offset.x, skillWindow[0].skillManaUseRect.y + (((i+playerSkill.passiveSkill.Count) * skillWindow[0].skillManaUseRect.height) * skillWindow[0].spaceSkillManaUse) + skillWindow[0].offset.y, skillWindow[0].skillManaUseRect.width, skillWindow[0].skillManaUseRect.height), new GUIContent("MP "+ playerSkill.activeSkillSupport[i].mpUse.ToString() ,"skillWindow"+(i).ToString()), guiStyleGroup[0].skillManaUseStyle);
				GUI.Box(new Rect(skillWindow[0].skillDescriptionRect.x + skillWindow[0].offset.x, skillWindow[0].skillDescriptionRect.y + (((i+playerSkill.passiveSkill.Count) * skillWindow[0].skillDescriptionRect.height) * skillWindow[0].spaceDescription) + skillWindow[0].offset.y, skillWindow[0].skillDescriptionRect.width, skillWindow[0].skillDescriptionRect.height), new GUIContent(playerSkill.activeSkillSupport[i].description ,"skillWindow"+(i).ToString()), guiStyleGroup[0].skillDescriptionStyle);
				...
				GUI.Box(new Rect(skillWindow[0].skillNameRect.x + skillWindow[0].offset.x, skillWindow[0].skillNameRect.y + (((i+playerSkill.passiveSkill.Count) * skillWindow[0].skillNameRect.height) * skillWindow[0].spaceSkillName) + skillWindow[0].offset.y, skillWindow[0].skillNameRect.width, skillWindow[0].skillNameRect.height), new GUIContent(playerSkill.activeSkillSupport[i].skillName ,"skillWindow"+(i).ToString()));
				GUI.Box(new Rect(skillWindow[0].skillTypeRect.x + skillWindow[0].offset.x, skillWindow[0].skillTypeRect.y + (((i+playerSkill.passiveSkill.Count) * skillWindow[0].skillTypeRect.height) * skillWindow[0].spaceSkillType) + skillWindow[0].offset.y, skillWindow[0].skillTypeRect.width, skillWindow[0].skillTypeRect.height), new GUIContent(playerSkill.activeSkillSupport[i].typeSkill ,"skillWindow"+(i).ToString()));
				GUI.Box(new Rect(skillWindow[0].skillManaUseRect.x + skillWindow[0].offset.x, skillWindow[0].skillManaUseRect.y + (((i+playerSkill.passiveSkill.Count) * skillWindow[0].skillManaUseRect.height) * skillWindow[0].spaceSkillManaUse) + skillWindow[0].offset.y, skillWindow[0].skillManaUseRect.width, skillWindow[0].skillManaUseRect.height), new GUIContent("MP "+playerSkill.activeSkillSupport[i].mpUse.ToString() ,"skillWindow"+(i).ToString()));
				GUI.Box(new Rect(skillWindow[0].skillDescriptionRect.x + skillWindow[0].offset.x, skillWindow[0].skillDescriptionRect.y + (((i+playerSkill.passiveSkill.Count) * skillWindow[0].skillDescriptionRect.height) * skillWindow[0].spaceDescription) + skillWindow[0].offset.y, skillWindow[0].skillDescriptionRect.width, skillWindow[0].skillDescriptionRect.height), new GUIContent(playerSkill.activeSkillSupport[i].description ,"skillWindow"+(i).ToString()));
			}
			
			GUI.DrawTexture(new Rect(skillWindow[0].slotSkillRect.x + skillWindow[0].offset.x, skillWindow[0].slotSkillRect.y + (((i+playerSkill.passiveSkill.Count) * skillWindow[0].slotSkillRect.height) * skillWindow[0].space) + skillWindow[0].offset.y , skillWindow[0].slotSkillRect.width, skillWindow[0].slotSkillRect.height), playerSkill.activeSkillSupport[i].skillIcon);		
		
			if(playerStatus.status.lv < playerSkill.activeSkillSupport[i].unlockLevel){
				...
				if(useStyle){
					GUI.Label(new Rect(skillWindow[0].slotSkillRect.x + skillWindow[0].offset.x, skillWindow[0].slotSkillRect.y + (((i+playerSkill.passiveSkill.Count) * skillWindow[0].slotSkillRect.height) * skillWindow[0].space) + skillWindow[0].offset.y , skillWindow[0].slotSkillRect.width, skillWindow[0].slotSkillRect.height), "LV "+ playerSkill.activeSkillSupport[i].unlockLevel.ToString(), guiStyleGroup[0].textLvUnlockStyle);
				}else{
					GUI.Label(new Rect(skillWindow[0].slotSkillRect.x + skillWindow[0].offset.x, skillWindow[0].slotSkillRect.y + (((i+playerSkill.passiveSkill.Count) * skillWindow[0].slotSkillRect.height) * skillWindow[0].space) + skillWindow[0].offset.y , skillWindow[0].slotSkillRect.width, skillWindow[0].slotSkillRect.height), "LV "+ playerSkill.activeSkillSupport[i].unlockLevel.ToString());
				}
			}
		}
		...
		for(int i = 0; i < playerSkill.activeSkillAttack.Count; i++){
			if(useStyle){
				GUI.Box(new Rect(skillWindow[0].slotSkillRect.x + skillWindow[0].offset.x, skillWindow[0].slotSkillRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].slotSkillRect.height) * skillWindow[0].space) + skillWindow[0].offset.y, skillWindow[0].slotSkillRect.width, skillWindow[0].slotSkillRect.height), new GUIContent("","skillWindow"+(i).ToString()), guiStyleGroup[0].skillSlotStyle);	
				GUI.Box(new Rect(skillWindow[0].descriptionRect.x + skillWindow[0].offset.x, skillWindow[0].descriptionRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].descriptionRect.height) * skillWindow[0].space) + skillWindow[0].offset.y, skillWindow[0].descriptionRect.width, skillWindow[0].descriptionRect.height), new GUIContent("" ,"skillWindow"+(i).ToString()), guiStyleGroup[0].descriptionSkillSlotStyle);
			
				GUI.Box(new Rect(skillWindow[0].skillNameRect.x + skillWindow[0].offset.x, skillWindow[0].skillNameRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].skillNameRect.height) * skillWindow[0].spaceSkillName) + skillWindow[0].offset.y, skillWindow[0].skillNameRect.width, skillWindow[0].skillNameRect.height), new GUIContent(playerSkill.activeSkillAttack[i].skillName ,"skillWindow"+(i).ToString()), guiStyleGroup[0].skillNameStyle);
				GUI.Box(new Rect(skillWindow[0].skillTypeRect.x + skillWindow[0].offset.x, skillWindow[0].skillTypeRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].skillTypeRect.height) * skillWindow[0].spaceSkillType) + skillWindow[0].offset.y, skillWindow[0].skillTypeRect.width, skillWindow[0].skillTypeRect.height), new GUIContent(playerSkill.activeSkillAttack[i].typeSkill ,"skillWindow"+(i).ToString()), guiStyleGroup[0].skillTypeStyle);
				GUI.Box(new Rect(skillWindow[0].skillManaUseRect.x + skillWindow[0].offset.x, skillWindow[0].skillManaUseRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].skillManaUseRect.height) * skillWindow[0].spaceSkillManaUse) + skillWindow[0].offset.y, skillWindow[0].skillManaUseRect.width, skillWindow[0].skillManaUseRect.height), new GUIContent("MP "+playerSkill.activeSkillAttack[i].mpUse.ToString() ,"skillWindow"+(i).ToString()), guiStyleGroup[0].skillManaUseStyle);
				GUI.Box(new Rect(skillWindow[0].skillDescriptionRect.x + skillWindow[0].offset.x, skillWindow[0].skillDescriptionRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].skillDescriptionRect.height) * skillWindow[0].spaceDescription) + skillWindow[0].offset.y, skillWindow[0].skillDescriptionRect.width, skillWindow[0].skillDescriptionRect.height), new GUIContent(playerSkill.activeSkillAttack[i].description ,"skillWindow"+(i).ToString()), guiStyleGroup[0].skillDescriptionStyle);
			
			}else{
				GUI.Box(new Rect(skillWindow[0].slotSkillRect.x + skillWindow[0].offset.x, skillWindow[0].slotSkillRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].slotSkillRect.height) * skillWindow[0].space) + skillWindow[0].offset.y, skillWindow[0].slotSkillRect.width, skillWindow[0].slotSkillRect.height), new GUIContent("","skillWindow"+(i).ToString()));	
				GUI.Box(new Rect(skillWindow[0].descriptionRect.x + skillWindow[0].offset.x, skillWindow[0].descriptionRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].descriptionRect.height) * skillWindow[0].space) + skillWindow[0].offset.y, skillWindow[0].descriptionRect.width, skillWindow[0].descriptionRect.height), new GUIContent("" ,"skillWindow"+(i).ToString()));
				
				GUI.Box(new Rect(skillWindow[0].skillNameRect.x + skillWindow[0].offset.x, skillWindow[0].skillNameRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].skillNameRect.height) * skillWindow[0].spaceSkillName) + skillWindow[0].offset.y, skillWindow[0].skillNameRect.width, skillWindow[0].skillNameRect.height), new GUIContent(playerSkill.activeSkillAttack[i].skillName ,"skillWindow"+(i).ToString()));
				...
				GUI.Box(new Rect(skillWindow[0].skillManaUseRect.x + skillWindow[0].offset.x, skillWindow[0].skillManaUseRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].skillManaUseRect.height) * skillWindow[0].spaceSkillManaUse) + skillWindow[0].offset.y, skillWindow[0].skillManaUseRect.width, skillWindow[0].skillManaUseRect.height), new GUIContent("MP "+playerSkill.activeSkillAttack[i].mpUse.ToString() ,"skillWindow"+(i).ToString()));
				GUI.Box(new Rect(skillWindow[0].skillDescriptionRect.x + skillWindow[0].offset.x, skillWindow[0].skillDescriptionRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].skillDescriptionRect.height) * skillWindow[0].spaceDescription) + skillWindow[0].offset.y, skillWindow[0].skillDescriptionRect.width, skillWindow[0].skillDescriptionRect.height), new GUIContent(playerSkill.activeSkillAttack[i].description ,"skillWindow"+(i).ToString()));
			
			}
			
			GUI.DrawTexture(new Rect(skillWindow[0].slotSkillRect.x + skillWindow[0].offset.x, skillWindow[0].slotSkillRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].slotSkillRect.height) * skillWindow[0].space) + skillWindow[0].offset.y , skillWindow[0].slotSkillRect.width, skillWindow[0].slotSkillRect.height), playerSkill.activeSkillAttack[i].skillIcon);		
			
			if(playerStatus.status.lv < playerSkill.activeSkillAttack[i].unlockLevel){
				GUI.DrawTexture(new Rect(skillWindow[0].slotSkillRect.x + skillWindow[0].offset.x, skillWindow[0].slotSkillRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].slotSkillRect.height) * skillWindow[0].space) + skillWindow[0].offset.y , skillWindow[0].slotSkillRect.width, skillWindow[0].slotSkillRect.height), skillWindow[0].lockSkillTexture);	
				
				if(useStyle){
					GUI.Label(new Rect(skillWindow[0].slotSkillRect.x + skillWindow[0].offset.x, skillWindow[0].slotSkillRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].slotSkillRect.height) * skillWindow[0].space) + skillWindow[0].offset.y , skillWindow[0].slotSkillRect.width, skillWindow[0].slotSkillRect.height), "LV "+ playerSkill.activeSkillAttack[i].unlockLevel.ToString(), guiStyleGroup[0].textLvUnlockStyle);	
				}else{
					GUI.Label(new Rect(skillWindow[0].slotSkillRect.x + skillWindow[0].offset.x, skillWindow[0].slotSkillRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].slotSkillRect.height) * skillWindow[0].space) + skillWindow[0].offset.y , skillWindow[0].slotSkillRect.width, skillWindow[0].slotSkillRect.height), "LV "+ playerSkill.activeSkillAttack[i].unlockLevel.ToString());	
				}
			}
		}
	...
	private int CheckSlotSkill(){
		...
		for(int i = 0; i < playerSkill.activeSkillAttack.Count; i++){
			...
			Vector2 endPos = Vector2.zero;
			startPos.x = skillWindow[0].windowSkillRect.x + skillWindow[0].slotSkillRect.x + skillWindow[0].scrollViewPosition.x;
			startPos.y = skillWindow[0].windowSkillRect.y + (skillWindow[0].scrollViewPosition.y - skillWindow[0].positionTunerHittest ) + skillWindow[0].slotSkillRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].slotSkillRect.height) * skillWindow[0].space) + skillWindow[0].offset.y ;
			endPos.x = skillWindow[0].windowSkillRect.x + (skillWindow[0].slotSkillRect.x + skillWindow[0].slotSkillRect.width) + skillWindow[0].scrollViewPosition.x;
			endPos.y = skillWindow[0].windowSkillRect.y + (skillWindow[0].scrollViewPosition.y - skillWindow[0].positionTunerHittest ) + ((skillWindow[0].slotSkillRect.y + (((i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count) * skillWindow[0].slotSkillRect.height) * skillWindow[0].space) + skillWindow[0].offset.y) + skillWindow[0].slotSkillRect.height);
			...
			if(HitTestWindow(startPos, endPos)){
				...
				return i+playerSkill.passiveSkill.Count+playerSkill.activeSkillSupport.Count;	
			}
		}
	...
	private void AddStatEquipmentToPlayer(Item_Data.Item item){
		...
		//Add effect item to Player
		playerStatus.statusEquip.atk += item.atk;
		playerStatus.statusEquip.atkSpd += item.atkSpd;
		playerStatus.statusEquip.criticalRate += item.criPercent;
		playerStatus.statusEquip.def += item.def;
		playerStatus.statusEquip.hit += item.hit;
		playerStatus.statusEquip.hp += item.hp;
		playerStatus.statusEquip.movespd += item.moveSpd;
		playerStatus.statusEquip.mp += item.mp;
		playerStatus.statusEquip.spd += item.spd;
		playerStatus.statusEquip.atkRange += item.atkRange;
