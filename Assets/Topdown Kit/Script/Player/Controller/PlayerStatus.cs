...
public class PlayerStatus : MonoBehaviour {
	...
	public StatusGrowth statusGrowth,growthSetting; //升级后属性成长值status growth when level up
	...
	void Start () {
        ...
        //初始化了最大生命值和最大魔法值
        //调用了自动回复生命和魔法的方法
		expMax = startExp * status.lv *multipleExp;//最大经验值计算公式
		Invoke("SettingStatus",0.1f);//0.1秒之后调用此方法
		alreadyApply = true;
